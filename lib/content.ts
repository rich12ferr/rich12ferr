export const profile = {
  ...
  positioning:
    'I build connected platforms that transform fragmented identity, data, consent, integration, and developer capabilities into reusable enterprise ecosystems.',
  summary:
    'Senior product leader with 15+ years building and scaling platform, identity, data, and AI-powered products in regulated environments. My work has increasingly focused on Director-level challenges: setting strategy across complex domains, aligning executive stakeholders, guiding cross-functional teams, and building the product foundations that help organizations scale with more clarity, security, and speed.',
  summaryExtended:
